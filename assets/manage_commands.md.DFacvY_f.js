import{_ as a,o as n,c as p,ag as l}from"./chunks/framework.BmLMQRXF.js";const g=JSON.parse('{"title":"All Commands","description":"","frontmatter":{},"headers":[],"relativePath":"manage/commands.md","filePath":"manage/commands.md","lastUpdated":1738767514000}'),e={name:"manage/commands.md"};function t(i,s,o,c,r,d){return n(),p("div",null,s[0]||(s[0]=[l(`<h1 id="all-commands" tabindex="-1">All Commands <a class="header-anchor" href="#all-commands" aria-label="Permalink to &quot;All Commands&quot;">​</a></h1><p>The list of all commands available in <code>asdf</code>. This list is the <code>asdf help</code> command text.</p><div class="language-txt vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>MANAGE PLUGINS</span></span>
