import{_ as n,o as a,c as p,ag as e}from"./chunks/framework.BmLMQRXF.js";const f=JSON.parse('{"title":"所有命令","description":"","frontmatter":{},"headers":[],"relativePath":"zh-hans/manage/commands.md","filePath":"zh-hans/manage/commands.md","lastUpdated":1738767514000}'),l={name:"zh-hans/manage/commands.md"};function t(i,s,o,c,r,d){return a(),p("div",null,s[0]||(s[0]=[e(`<h1 id="所有命令" tabindex="-1">所有命令 <a class="header-anchor" href="#所有命令" aria-label="Permalink to &quot;所有命令&quot;">​</a></h1><p><code>asdf</code> 中所有可用命令的列表。这个列表就是 <code>asdf help</code> 命令的打印内容。</p><div class="language-txt vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>MANAGE PLUGINS</span></span>
